...
public class ClosedRule {
	private AItemset itemset1; // antecedent
	private AItemset itemset2; // consequent
	 ...
	 */
	public ClosedRule(AItemset itemset1, AItemset itemset2, int transactionCount, double confidence){
